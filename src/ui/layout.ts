...
export const MOBILE_LAYOUT = {
  ...
  board: { defenseLeft: 220, battlefieldLeft: 570, top: 150, defenseCellWidth: 160, battlefieldCellWidth: 130, rowHeight: 176, rows: 5, columns: 12 },
  spawnSlot: { left: 45, width: 150, centerY: 590, height: 480 },
  header: { scoreY: 36, settingsX: 1834 }, defenseColumns: 2,
} as const;
